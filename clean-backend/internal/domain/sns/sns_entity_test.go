...
func TestNewSns(t *testing.T) {
	t.Run("有効な入力を渡したとき処理に成功する", func(t *testing.T) {
		...
		s, err := New(uuid.String(), "Instagram", "https://www.instagram.com", "https://example.com/icon.png")
		if err != nil {
	...
	t.Run("名前が不正なときバリデーションエラーで失敗する", func(t *testing.T) {
		...
		uuid := mustNewUUID("11111111-1111-4111-8111-111111111111")
		_, err := New(uuid.String(), "", "https://www.instagram.com", "")
		if err == nil {
	...
	t.Run("URLが不正なときバリデーションエラーで失敗する", func(t *testing.T) {
		...
		uuid := mustNewUUID("11111111-1111-4111-8111-111111111111")
		_, err := New(uuid.String(), "Instagram", "not-url", "")
		if err == nil {
			t.Fatalf("expected error")
		}
