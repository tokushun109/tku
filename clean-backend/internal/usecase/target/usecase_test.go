...
func (s *stubRepo) Create(ctx context.Context, t *domain.Target) (*domain.Target, error) {
	s.created = t
	if s.createErr != nil {
...
func (s *stubRepo) FindByName(ctx context.Context, name domain.TargetName) (*domain.Target, error) {
	return nil, nil
}
