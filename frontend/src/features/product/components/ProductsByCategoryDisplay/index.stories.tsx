...
const mockProductsByCategory: IProductsByCategory = {
    ...
    products: [
        ...
        },
        {
            ...
            isActive: true,
            isRecommend: false,
            productImages: [{ uuid: '2', apiPath: '/image/about/story.jpg', name: 'image2', order: 1 }],
            target: { uuid: '1', name: 'レディース' },
            category: { uuid: '1', name: 'ピアス' },
            tags: [],
            siteDetails: [],
        },
        {
            ...
            isActive: true,
            isRecommend: false,
            productImages: [{ uuid: '3', apiPath: '/image/about/story.jpg', name: 'image3', order: 1 }],
            target: { uuid: '1', name: 'レディース' },
            category: { uuid: '1', name: 'ピアス' },
            tags: [],
            siteDetails: [],
        },
        {
            ...
            isActive: true,
            isRecommend: false,
            productImages: [{ uuid: '4', apiPath: '/image/about/story.jpg', name: 'image4', order: 1 }],
            target: { uuid: '1', name: 'レディース' },
            category: { uuid: '1', name: 'ピアス' },
            tags: [],
            siteDetails: [],
        },
        {
            ...
            isActive: true,
            isRecommend: false,
            productImages: [{ uuid: '5', apiPath: '/image/about/story.jpg', name: 'image5', order: 1 }],
            target: { uuid: '1', name: 'レディース' },
            category: { uuid: '1', name: 'ピアス' },
            tags: [],
            siteDetails: [],
        },
        {
            ...
            isActive: true,
            isRecommend: false,
            productImages: [{ uuid: '6', apiPath: '/image/about/story.jpg', name: 'image6', order: 1 }],
            target: { uuid: '1', name: 'レディース' },
            category: { uuid: '1', name: 'ピアス' },
            tags: [],
            siteDetails: [],
        ...
        productsByCategory: {
            ...
            products: [
                ...mockProductsByCategory.products,
                {
                    ...
                    isActive: true,
                    isRecommend: false,
                    productImages: [{ uuid: '7', apiPath: '/image/about/story.jpg', name: 'image7', order: 1 }],
                    target: { uuid: '1', name: 'レディース' },
                    category: { uuid: '1', name: 'ピアス' },
                    tags: [],
                    siteDetails: [],
                },
                {
                    ...
                    isActive: true,
                    isRecommend: false,
                    productImages: [{ uuid: '8', apiPath: '/image/about/story.jpg', name: 'image8', order: 1 }],
                    target: { uuid: '1', name: 'レディース' },
                    category: { uuid: '1', name: 'ピアス' },
                    tags: [],
                    siteDetails: [],
