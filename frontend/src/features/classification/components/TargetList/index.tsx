...
import { createTarget, deleteTarget, updateTarget } from '@/apis/target'
...
export const TargetList = ({ items, onUpdate }: Props) => {
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            console.error('ターゲットの作成エラー:', error)
        } finally {
            setLoading(false)
        }
    }
    ...
    const handleEdit = async () => {
        ...
        try {
            ...
            console.error('ターゲットの編集エラー:', error)
        } finally {
            setLoading(false)
        }
    }
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            console.error('ターゲットの削除エラー:', error)
        } finally {
            setLoading(false)
        }
    }
